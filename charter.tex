...
\titulo{Desarrollo de un controlador para un sensor lineal de carga acoplada con aplicaciones en sensado remoto} 
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en \textcolor{black}{el desarrollo e implementación de un prototipo de sistema  de adquisicion de imagenes por medio de un sensor lineal de carga acoplada}, y tendrá un presupuesto preliminar estimado de \textcolor{black}{600} hs de trabajo y \textcolor{black}{\$50000}, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
