...
\begin{enumerate}
	\item Requerimientos funcionales
		\begin{enumerate}
			\item El sistema debe adquirir como máximo 2000 lineas por segundo
	...
	\begin{enumerate}
			\item Comunicacion con PC a traves de puerto USB
			\item La apliacion en PC almacena y visualiza los datos
			\item la interfaz debe mostrat estimadores como la mediana, valores maximos y mínimos de la senial.
		\end{enumerate}
